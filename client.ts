...
export const getClient = async () => {
  ...
  const SOLANA_PRIVATE_KEY = process.env.SVM_PRIVATE_KEY as string;
  const MCP_SERVER_URL = "http://localhost:3011/mcp"
  ...
  // Casting to align SDK Client types from different dependency trees
